...
public class Player : MonoBehaviour
{
    ...
    public void Push(Vector3 direction, float duration = 0)
    {
    ...
    private void BecomeAirborne()
    {
        ...
        if (rb.velocity.y <= 0) // use <= instead of <
        {
            ActivateCoyoteJump();
        }
    }
    ...
    private void AttemptBufferJump()
    {
        ...
        {
            bufferJumpActivated = Time.time - 1; // just put = 0 in future scripts
            Jump();
        }
    }
    ...
    private void CancelCoyoteJump() => coyoteJumpActivated = Time.time - 1; // just put = 0 in future scripts
    #endregion
